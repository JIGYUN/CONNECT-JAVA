...
import { useTestByDate, useUpsertTest } from '@/shared/test';
import type { TestEntry, TestUpsertInput } from '@/shared/test';
...
function pickHtmlSafe(v: TestEntry | null | undefined): string {
    if (!v) return '';
...
export default function TestPage() {
    ...
    const q: UseQueryResult<TestEntry | null, Error> = useTestByDate({
        diaryDt: selected,
        grpCd,
        ownerId,
    });

    const upsert: UseMutationResult<void, Error, TestUpsertInput, unknown> = useUpsertTest({ grpCd, ownerId });
    ...
    return (
        <div className="test-root" style={{ maxWidth: PAGE_MAX_WIDTH, margin: '0 auto', padding: 16 }}>
            {/* 헤더 */}
            ...
            <style jsx>{`
                ...
                .test-calendar { width: 100%; table-layout: fixed; border-collapse: collapse; }
                .test-calendar thead tr { background: #f8fafc; color: #0f172a; }
                .test-calendar th { padding: 10px 0; font-weight: 700; }
                .test-calendar td {
