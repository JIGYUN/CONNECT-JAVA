...
import { useCartByDate, useUpsertCart } from '@/shared/cart';
import type { CartEntry, CartUpsertInput } from '@/shared/cart';
...
function pickHtmlSafe(v: CartEntry | null | undefined): string {
    if (!v) return '';
...
export default function CartPage() {
    ...
    const q: UseQueryResult<CartEntry | null, Error> = useCartByDate({
        diaryDt: selected,
        grpCd,
        ownerId,
    });

    const upsert: UseMutationResult<void, Error, CartUpsertInput, unknown> = useUpsertCart({ grpCd, ownerId });
    ...
    return (
        <div className="cart-root" style={{ maxWidth: PAGE_MAX_WIDTH, margin: '0 auto', padding: 16 }}>
            {/* 헤더 */}
            ...
            <style jsx>{`
                ...
                .cart-calendar { width: 100%; table-layout: fixed; border-collapse: collapse; }
                .cart-calendar thead tr { background: #f8fafc; color: #0f172a; }
                .cart-calendar th { padding: 10px 0; font-weight: 700; }
                .cart-calendar td {
