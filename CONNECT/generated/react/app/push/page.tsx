// filepath: src/app/push/page.tsx
'use client';

import { useEffect, useMemo, useRef, useState, type ComponentType } from 'react';
import { useSearchParams } from 'next/navigation';
import { usePushByDate, useUpsertPush } from '@/shared/push';
import type { PushEntry, PushUpsertInput } from '@/shared/push';
...
function pickHtmlSafe(v: PushEntry | null | undefined): string {
    if (!v) return '';
...
export default function PushPage() {
    ...
    const q: UseQueryResult<PushEntry | null, Error> = usePushByDate({
        diaryDt: selected,
        grpCd,
        ownerId,
    });

    const upsert: UseMutationResult<void, Error, PushUpsertInput, unknown> = useUpsertPush({ grpCd, ownerId });
    ...
    return (
        <div className="push-root" style={{ maxWidth: PAGE_MAX_WIDTH, margin: '0 auto', padding: 16 }}>
            {/* 헤더 */}
            ...
            <style jsx>{`
                ...
                .push-calendar { width: 100%; table-layout: fixed; border-collapse: collapse; }
                .push-calendar thead tr { background: #f8fafc; color: #0f172a; }
                .push-calendar th { padding: 10px 0; font-weight: 700; }
                .push-calendar td {
