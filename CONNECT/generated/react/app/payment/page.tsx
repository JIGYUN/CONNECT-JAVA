// filepath: src/app/payment/page.tsx
'use client';

import { useEffect, useMemo, useRef, useState, type ComponentType } from 'react';
import { useSearchParams } from 'next/navigation';
import { usePaymentByDate, useUpsertPayment } from '@/shared/payment';
import type { PaymentEntry, PaymentUpsertInput } from '@/shared/payment';
...
function pickHtmlSafe(v: PaymentEntry | null | undefined): string {
    if (!v) return '';
...
export default function PaymentPage() {
    ...
    const q: UseQueryResult<PaymentEntry | null, Error> = usePaymentByDate({
        diaryDt: selected,
        grpCd,
        ownerId,
    });

    const upsert: UseMutationResult<void, Error, PaymentUpsertInput, unknown> = useUpsertPayment({ grpCd, ownerId });
    ...
    return (
        <div className="payment-root" style={{ maxWidth: PAGE_MAX_WIDTH, margin: '0 auto', padding: 16 }}>
            {/* 헤더 */}
            ...
            <style jsx>{`
                ...
                .payment-calendar { width: 100%; table-layout: fixed; border-collapse: collapse; }
                .payment-calendar thead tr { background: #f8fafc; color: #0f172a; }
                .payment-calendar th { padding: 10px 0; font-weight: 700; }
                .payment-calendar td {
