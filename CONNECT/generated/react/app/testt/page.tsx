// filepath: src/app/testt/page.tsx
'use client';

import { useEffect, useMemo, useRef, useState, type ComponentType } from 'react';
import { useSearchParams } from 'next/navigation';
import { useTesttByDate, useUpsertTestt } from '@/shared/testt';
import type { TesttEntry, TesttUpsertInput } from '@/shared/testt';
...
function pickHtmlSafe(v: TesttEntry | null | undefined): string {
    if (!v) return '';
...
export default function TesttPage() {
    ...
    const q: UseQueryResult<TesttEntry | null, Error> = useTesttByDate({
        diaryDt: selected,
        grpCd,
        ownerId,
    });

    const upsert: UseMutationResult<void, Error, TesttUpsertInput, unknown> = useUpsertTestt({ grpCd, ownerId });
    ...
    return (
        <div className="testt-root" style={{ maxWidth: PAGE_MAX_WIDTH, margin: '0 auto', padding: 16 }}>
            {/* 헤더 */}
            ...
            <div className="calendar-wrap" style={{ border: '1px solid #e9edf3', borderRadius: 12, overflow: 'hidden', marginBottom: 12 }}>
                <table className="testt-calendar">
            ...
            <style jsx>{`
                ...
                .testt-calendar { width: 100%; table-layout: fixed; border-collapse: collapse; }
                .testt-calendar thead tr { background: #f8fafc; color: #0f172a; }
                .testt-calendar th { padding: 10px 0; font-weight: 700; }
                .testt-calendar td {
