// filepath: src/app/reservation/page.tsx
'use client';

import { useEffect, useMemo, useRef, useState, type ComponentType } from 'react';
import { useSearchParams } from 'next/navigation';
import { useReservationByDate, useUpsertReservation } from '@/shared/reservation';
import type { ReservationEntry, ReservationUpsertInput } from '@/shared/reservation';
...
function pickHtmlSafe(v: ReservationEntry | null | undefined): string {
    if (!v) return '';
...
export default function ReservationPage() {
    ...
    const q: UseQueryResult<ReservationEntry | null, Error> = useReservationByDate({
        diaryDt: selected,
        grpCd,
        ownerId,
    });

    const upsert: UseMutationResult<void, Error, ReservationUpsertInput, unknown> = useUpsertReservation({ grpCd, ownerId });
    ...
    return (
        <div className="reservation-root" style={{ maxWidth: PAGE_MAX_WIDTH, margin: '0 auto', padding: 16 }}>
            {/* 헤더 */}
            ...
            <style jsx>{`
                ...
                .reservation-calendar { width: 100%; table-layout: fixed; border-collapse: collapse; }
                .reservation-calendar thead tr { background: #f8fafc; color: #0f172a; }
                .reservation-calendar th { padding: 10px 0; font-weight: 700; }
