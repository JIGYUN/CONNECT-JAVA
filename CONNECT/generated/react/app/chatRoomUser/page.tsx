// filepath: src/app/chatRoomUser/page.tsx
'use client';

import { useEffect, useMemo, useRef, useState, type ComponentType } from 'react';
import { useSearchParams } from 'next/navigation';
import { useChatRoomUserByDate, useUpsertChatRoomUser } from '@/shared/chatRoomUser';
import type { ChatRoomUserEntry, ChatRoomUserUpsertInput } from '@/shared/chatRoomUser';
...
function pickHtmlSafe(v: ChatRoomUserEntry | null | undefined): string {
    if (!v) return '';
...
export default function ChatRoomUserPage() {
    ...
    const q: UseQueryResult<ChatRoomUserEntry | null, Error> = useChatRoomUserByDate({
        diaryDt: selected,
        grpCd,
        ownerId,
    });

    const upsert: UseMutationResult<void, Error, ChatRoomUserUpsertInput, unknown> = useUpsertChatRoomUser({ grpCd, ownerId });
    ...
    return (
        <div className="chatRoomUser-root" style={{ maxWidth: PAGE_MAX_WIDTH, margin: '0 auto', padding: 16 }}>
            {/* 헤더 */}
            ...
            <div className="calendar-wrap" style={{ border: '1px solid #e9edf3', borderRadius: 12, overflow: 'hidden', marginBottom: 12 }}>
                <table className="chatRoomUser-calendar">
            ...
            <style jsx>{`
                ...
                .chatRoomUser-calendar { width: 100%; table-layout: fixed; border-collapse: collapse; }
                .chatRoomUser-calendar thead tr { background: #f8fafc; color: #0f172a; }
                .chatRoomUser-calendar th { padding: 10px 0; font-weight: 700; }
                .chatRoomUser-calendar td {
