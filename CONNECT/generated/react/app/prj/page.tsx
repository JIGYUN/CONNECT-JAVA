// filepath: src/app/prj/page.tsx
'use client';

import { useEffect, useMemo, useRef, useState, type ComponentType } from 'react';
import { useSearchParams } from 'next/navigation';
import { useprjByDate, useUpsertprj } from '@/shared/prj';
import type { prjEntry, prjUpsertInput } from '@/shared/prj';
...
function pickHtmlSafe(v: prjEntry | null | undefined): string {
    if (!v) return '';
...
export default function prjPage() {
    ...
    const q: UseQueryResult<prjEntry | null, Error> = useprjByDate({
        diaryDt: selected,
        grpCd,
        ownerId,
    });

    const upsert: UseMutationResult<void, Error, prjUpsertInput, unknown> = useUpsertprj({ grpCd, ownerId });
    ...
    return (
        <div className="prj-root" style={{ maxWidth: PAGE_MAX_WIDTH, margin: '0 auto', padding: 16 }}>
            {/* 헤더 */}
            ...
            <style jsx>{`
                ...
                .prj-calendar { width: 100%; table-layout: fixed; border-collapse: collapse; }
                .prj-calendar thead tr { background: #f8fafc; color: #0f172a; }
                .prj-calendar th { padding: 10px 0; font-weight: 700; }
                .prj-calendar td {
