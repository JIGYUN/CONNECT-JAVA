// filepath: src/app/couponUser/page.tsx
'use client';

import { useEffect, useMemo, useRef, useState, type ComponentType } from 'react';
import { useSearchParams } from 'next/navigation';
import { useCouponUserByDate, useUpsertCouponUser } from '@/shared/couponUser';
import type { CouponUserEntry, CouponUserUpsertInput } from '@/shared/couponUser';
...
function pickHtmlSafe(v: CouponUserEntry | null | undefined): string {
    if (!v) return '';
...
export default function CouponUserPage() {
    ...
    const q: UseQueryResult<CouponUserEntry | null, Error> = useCouponUserByDate({
        diaryDt: selected,
        grpCd,
        ownerId,
    });

    const upsert: UseMutationResult<void, Error, CouponUserUpsertInput, unknown> = useUpsertCouponUser({ grpCd, ownerId });
    ...
    return (
        <div className="couponUser-root" style={{ maxWidth: PAGE_MAX_WIDTH, margin: '0 auto', padding: 16 }}>
            {/* 헤더 */}
            ...
            <div className="calendar-wrap" style={{ border: '1px solid #e9edf3', borderRadius: 12, overflow: 'hidden', marginBottom: 12 }}>
                <table className="couponUser-calendar">
            ...
            <style jsx>{`
                ...
                .couponUser-calendar { width: 100%; table-layout: fixed; border-collapse: collapse; }
                .couponUser-calendar thead tr { background: #f8fafc; color: #0f172a; }
                .couponUser-calendar th { padding: 10px 0; font-weight: 700; }
                .couponUser-calendar td {
