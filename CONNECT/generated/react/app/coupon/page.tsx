// filepath: src/app/coupon/page.tsx
'use client';

import { useEffect, useMemo, useRef, useState, type ComponentType } from 'react';
import { useSearchParams } from 'next/navigation';
import { useCouponByDate, useUpsertCoupon } from '@/shared/coupon';
import type { CouponEntry, CouponUpsertInput } from '@/shared/coupon';
...
function pickHtmlSafe(v: CouponEntry | null | undefined): string {
    if (!v) return '';
...
export default function CouponPage() {
    ...
    const q: UseQueryResult<CouponEntry | null, Error> = useCouponByDate({
        diaryDt: selected,
        grpCd,
        ownerId,
    });

    const upsert: UseMutationResult<void, Error, CouponUpsertInput, unknown> = useUpsertCoupon({ grpCd, ownerId });
    ...
    return (
        <div className="coupon-root" style={{ maxWidth: PAGE_MAX_WIDTH, margin: '0 auto', padding: 16 }}>
            {/* 헤더 */}
            ...
            <div className="calendar-wrap" style={{ border: '1px solid #e9edf3', borderRadius: 12, overflow: 'hidden', marginBottom: 12 }}>
                <table className="coupon-calendar">
            ...
            <style jsx>{`
                ...
                .coupon-calendar { width: 100%; table-layout: fixed; border-collapse: collapse; }
                .coupon-calendar thead tr { background: #f8fafc; color: #0f172a; }
                .coupon-calendar th { padding: 10px 0; font-weight: 700; }
                .coupon-calendar td {
