// filepath: src/app/issue/page.tsx
'use client';

import { useEffect, useMemo, useRef, useState, type ComponentType } from 'react';
import { useSearchParams } from 'next/navigation';
import { useIssueByDate, useUpsertIssue } from '@/shared/issue';
import type { IssueEntry, IssueUpsertInput } from '@/shared/issue';
...
function pickHtmlSafe(v: IssueEntry | null | undefined): string {
    if (!v) return '';
...
export default function IssuePage() {
    ...
    const q: UseQueryResult<IssueEntry | null, Error> = useIssueByDate({
        diaryDt: selected,
        grpCd,
        ownerId,
    });

    const upsert: UseMutationResult<void, Error, IssueUpsertInput, unknown> = useUpsertIssue({ grpCd, ownerId });
    ...
    return (
        <div className="issue-root" style={{ maxWidth: PAGE_MAX_WIDTH, margin: '0 auto', padding: 16 }}>
            {/* 헤더 */}
            ...
            <div className="calendar-wrap" style={{ border: '1px solid #e9edf3', borderRadius: 12, overflow: 'hidden', marginBottom: 12 }}>
                <table className="issue-calendar">
            ...
            <style jsx>{`
                ...
                .issue-calendar { width: 100%; table-layout: fixed; border-collapse: collapse; }
                .issue-calendar thead tr { background: #f8fafc; color: #0f172a; }
                .issue-calendar th { padding: 10px 0; font-weight: 700; }
                .issue-calendar td {
