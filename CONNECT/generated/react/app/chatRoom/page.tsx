// filepath: src/app/chatRoom/page.tsx
'use client';

import { useEffect, useMemo, useRef, useState, type ComponentType } from 'react';
import { useSearchParams } from 'next/navigation';
import { useChatRoomByDate, useUpsertChatRoom } from '@/shared/chatRoom';
import type { ChatRoomEntry, ChatRoomUpsertInput } from '@/shared/chatRoom';
...
function pickHtmlSafe(v: ChatRoomEntry | null | undefined): string {
    if (!v) return '';
...
export default function ChatRoomPage() {
    ...
    const q: UseQueryResult<ChatRoomEntry | null, Error> = useChatRoomByDate({
        diaryDt: selected,
        grpCd,
        ownerId,
    });

    const upsert: UseMutationResult<void, Error, ChatRoomUpsertInput, unknown> = useUpsertChatRoom({ grpCd, ownerId });
    ...
    return (
        <div className="chatRoom-root" style={{ maxWidth: PAGE_MAX_WIDTH, margin: '0 auto', padding: 16 }}>
            {/* 헤더 */}
            ...
            <div className="calendar-wrap" style={{ border: '1px solid #e9edf3', borderRadius: 12, overflow: 'hidden', marginBottom: 12 }}>
                <table className="chatRoom-calendar">
            ...
            <style jsx>{`
                ...
                .chatRoom-calendar { width: 100%; table-layout: fixed; border-collapse: collapse; }
                .chatRoom-calendar thead tr { background: #f8fafc; color: #0f172a; }
                .chatRoom-calendar th { padding: 10px 0; font-weight: 700; }
                .chatRoom-calendar td {
