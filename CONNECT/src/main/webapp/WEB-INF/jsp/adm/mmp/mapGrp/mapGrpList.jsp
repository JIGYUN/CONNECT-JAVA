...
<script>
    ...
    function goNew() {
        location.href = '/adm/mmp/mapGrp/mapGrpModify';
    }

    function goDetail(id) {
        let url = '/adm/mmp/mapGrp/mapGrpModify';
    ...
    function goMapListByGrpCd(grpCd) {
        ...
        location.href = '/adm/mmp/map/mapList?grpCd=' + encodeURIComponent(grpCd);
    }

    function goPlaceManage(id) {
        if (!id) return;
        location.href = '/adm/mmp/place/placeList?' + PK + '=' + encodeURIComponent(id);
    }

    // ★ 통합 지도: grpCd 없이 목록으로
    function goUnified() {
        location.href = '/adm/mmp/map/mapList';
    }
</script>