...
<div class="wrap">
    ...
    <div class="toolbar">
        ...
        <a class="btn btn-outline-secondary" href="/adm/mmp/mapGrp/mapGrpList">목록</a>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div>
                        ...
                        <a class="btn btn-outline-primary" href="/adm/mmp/place/placeList" target="_blank">맛집 관리로 가기</a>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function save() {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (resGrpCd) {
                    location.href = '/adm/mmp/mapGrp/mapGrpDetail?grpCd=' + encodeURIComponent(resGrpCd);
                    return;
                }
                if (resId) {
                    location.href = '/adm/mmp/mapGrp/mapGrpDetail?mapGrpId=' + encodeURIComponent(resId);
                    return;
                }
                // 안전망: 목록으로
                location.href = '/adm/mmp/mapGrp/mapGrpList';
            },
            error: function () {
                alert('저장 오류');
            }
    ...
    function goPlaceManage() {
        const code = ($('#grpCd').val() || '').trim();
        const id = ($('#mapGrpId').val() || '').trim();
        if (code) { location.href = '/adm/mmp/place/placeList?grpCd=' + encodeURIComponent(code); return; }
        if (id)   { location.href = '/adm/mmp/place/placeList?mapGrpId=' + encodeURIComponent(id); return; }
        alert('먼저 저장하세요.');
    }
