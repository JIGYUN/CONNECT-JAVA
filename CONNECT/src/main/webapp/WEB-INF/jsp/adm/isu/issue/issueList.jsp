...
<section>
    ...
    <div class="mb-3">
        <button class="btn btn-primary" type="button" onclick="goToIssueModify()">글쓰기</button>
        <button class="btn btn-outline-secondary" type="button" onclick="goToIssue()">통합</button>
    </div>
...
<script>
    ...
    function goToIssueModify(id) {
        let url = '/adm/isu/issue/issueModify';
        if (id) url += '?' + issueId + '=' + encodeURIComponent(id);
        location.href = url;
    }

    function goToIssue() {
        location.href = '/adm/isu/issue/issue';
    }
</script>
