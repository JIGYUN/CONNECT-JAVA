...
<section>
    ...
    <div class="mb-3">
        <button class="btn btn-primary" type="button" onclick="goToChatMessageModify()">글쓰기</button>
        <button class="btn btn-outline-secondary" type="button" onclick="goToChatMessage()">통합</button>
    </div>
...
<script>
    ...
    function goToChatMessageModify(id) {
        let url = '/adm/cht/chatMessage/chatMessageModify';
        if (id) url += '?' + msgId + '=' + encodeURIComponent(id);
        location.href = url;
    }

    function goToChatMessage() {
        location.href = '/adm/cht/chatMessage/chatMessage';
    }
</script>
