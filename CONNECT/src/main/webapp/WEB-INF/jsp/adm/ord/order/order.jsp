...
<section>
    ...
    <div class="mb-3">
        <a class="btn btn-outline-secondary" href="/ord/order/orderList">목록</a>
    </div>
            ...
            success: function (map) {
                ...
                if (!resultList.length) {
                    ...
                    for (let i = 0; i < resultList.length; i++) {
                        ...
                        html += "            aria-label='항목 " + (r.orderIdx ?? '') + " 삭제'";
                        html += "            onclick=\"event.stopPropagation(); deleteRow('" + (r.orderIdx) + "')\">삭제</button>";
                        html += "  </td>";
                        html += "</tr>";
                    }
                }
