...
<section>
    ...
    <div class="mb-3">
        ...
        <a class="btn btn-outline-secondary" href="/adm/prd/product/productList">목록</a>
    </div>
...
<script>
    ...
    function readProduct(id) {
        ...
        $.ajax({
            ...
            success: function (map) {
                const result = map.result || map.product || map;
                if (!result) return;
    ...
    function saveProduct() {
        ...
        $.ajax({
            ...
            success: function () {
                location.href = "/adm/prd/product/productList";
            },
            error: function () {
                alert("저장 중 오류 발생");
            }
