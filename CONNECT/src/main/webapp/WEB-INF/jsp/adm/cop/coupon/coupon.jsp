...
<script>
            ...
            success: function (map) {
                ...
                if (!resultList.length) {
                    ...
                    for (let i = 0; i < resultList.length; i++) {
                        ...
                        html += "<tr onclick=\"goToCouponModify('" + (r.couponIdx) + "')\">";
                        html += "  <td class='text-right'>" + (r.couponIdx ?? '') + "</td>";
                        ...
                        html += "            aria-label='항목 " + (r.couponIdx ?? '') + " 삭제'";
                        html += "            onclick=\"event.stopPropagation(); deleteRow('" + (r.couponIdx) + "')\">삭제</button>";
                        html += "  </td>";
                        html += "</tr>";
                    }
                }
    ...
    function goToCouponModify(id) {
        let url = '/cop/coupon/couponModify';
        if (id) url += '?' + couponId + '=' + encodeURIComponent(id);
        location.href = url;
    }
