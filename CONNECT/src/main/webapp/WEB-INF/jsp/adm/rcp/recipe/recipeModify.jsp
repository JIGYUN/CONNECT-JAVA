...
<section class="container-fluid">
    ...
    <div class="mb-3 d-flex align-items-center" style="gap:8px;">
        ...
        <a class="btn btn-outline-secondary" href="/adm/rcp/recipe/recipeList">목록</a>
    </div>
...
<script>
    ...
    function save(){
        ...
        $.ajax({
            ...
            success: function(res){
                if (!id && res.recipeId){
                    location.href = '/adm/rcp/recipe/recipeModify?recipeId=' + encodeURIComponent(res.recipeId);
                } else {
                    alert('저장되었습니다.');
                }
            },
    ...
    function remove(){
        ...
        $.ajax({
            ...
            success: function(){
                alert('삭제되었습니다.');
                location.href = '/adm/rcp/recipe/recipeList';
            },
