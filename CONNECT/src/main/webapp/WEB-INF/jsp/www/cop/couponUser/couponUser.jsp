...
<section>
    ...
    <div class="mb-3">
        <a class="btn btn-outline-secondary" href="/cop/couponUser/couponUserList">목록</a>
    </div>
...
<script>
    ...
    const couponUserId = 'couponUserIdx';
            ...
            success: function (map) {
                ...
                if (!resultList.length) {
                    ...
                    for (let i = 0; i < resultList.length; i++) {
                        ...
                        html += "<tr onclick=\"goToCouponUserModify('" + (r.couponUserIdx) + "')\">";
                        html += "  <td class='text-right'>" + (r.couponUserIdx ?? '') + "</td>";
                        ...
                        html += "            aria-label='항목 " + (r.couponUserIdx ?? '') + " 삭제'";
                        html += "            onclick=\"event.stopPropagation(); deleteRow('" + (r.couponUserIdx) + "')\">삭제</button>";
                        html += "  </td>";
                        html += "</tr>";
                    }
                }
    ...
    function goToCouponUserModify(id) {
        ...
        if (id) url += '?' + couponUserId + '=' + encodeURIComponent(id);
        location.href = url;
    }
    ...
    function goToCouponUserList() {
        location.href = '/cop/couponUser/couponUserList';
    }
</script>
