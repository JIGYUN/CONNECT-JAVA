...
<script>
    ...
    function goNew(){
        location.href = '/rcp/recipe/recipeModify';
    }

    function goEdit(id){
        location.href = '/rcp/recipe/recipeModify?recipeId=' + encodeURIComponent(id);
    }
    
    function goDetail(id){
        location.href = '/rcp/recipe/recipeDetail?recipeId=' + encodeURIComponent(id);
    }
