...
<section>
    <h2 class="mb-3">포인트 거래 원장</h2>

    <div class="mb-3">
        <a class="btn btn-outline-secondary" href="/plg/pointLedger/pointLedgerList">목록</a>
    </div>
...
<script>
            ...
            success: function (map) {
                ...
                if (!resultList.length) {
                    ...
                    for (let i = 0; i < resultList.length; i++) {
                        ...
                        html += "            aria-label='항목 " + (r.pointLedgerIdx ?? '') + " 삭제'";
                        html += "            onclick=\"event.stopPropagation(); deleteRow('" + (r.pointLedgerIdx) + "')\">삭제</button>";
                        html += "  </td>";
                        html += "</tr>";
                    }
                }
    ...
    function insertTitle(title) {
        ...
        $.ajax({
            url: API_BASE + '/insertPointLedger',
            type: 'post',
            contentType: 'application/json',
            dataType: 'json',
    ...
    function goToPointLedgerModify(id) {
        let url = '/plg/pointLedger/pointLedgerModify';
    ...
    function goToPointLedgerList() {
        location.href = '/plg/pointLedger/pointLedgerList';
    }
</script>
