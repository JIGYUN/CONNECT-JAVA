 ...
 */
@Controller
@RequestMapping("/txn") // 예) /bbs
public class WebLedgerController {
    ...
    public String page(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "txn/ledger/ledger"; // 예) bbs/board/board.jsp
    }
    ...
    public String list(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "txn/ledger/ledgerList"; // 예) bbs/board/boardList.jsp
    }
    ...
    public String modify(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "txn/ledger/ledgerModify"; // 예) bbs/board/boardModify.jsp
    }
}
