 ...
 */
@Controller
@RequestMapping("/plg") // 예) /bbs
public class WebPointLedgerController {
    ...
    public String page(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "plg/pointLedger/pointLedger"; // 예) bbs/board/board.jsp
    }
    ...
    public String list(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "plg/pointLedger/pointLedgerList"; // 예) bbs/board/boardList.jsp
    }
    ...
    public String modify(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "plg/pointLedger/pointLedgerModify"; // 예) bbs/board/boardModify.jsp
    }
}
