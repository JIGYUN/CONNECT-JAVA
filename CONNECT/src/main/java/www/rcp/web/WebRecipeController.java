...
public class WebRecipeController {
    ...
    public String getRecipeModify(ModelMap model, @RequestParam HashMap<String, Object> map) throws Exception {
        ...
        ******************************************************/	
    	...
    	model.put("map", map);
        return "rcp/recipe/recipeModify"; 
    }
    ...
    public String getRecipeDetail(ModelMap model, @RequestParam HashMap<String, Object> map) throws Exception {
        if (UserSessionManager.isUserLogined()) {
        	model.put("userVO", UserSessionManager.getLoginUserVO());
        }
    	/*******************************************************
        ...
        ******************************************************/	
    	...
    	model.put("map", map);
        return "rcp/recipe/recipeDetail";  
    }
