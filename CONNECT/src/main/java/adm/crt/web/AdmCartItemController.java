 ...
 */
@Controller
@RequestMapping("/adm/crt") // 예) /bbs
public class AdmCartItemController {
    ...
    public String page(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/crt/cartItem/cartItem"; // 예) bbs/board/board.jsp
    }
    ...
    public String list(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/crt/cartItem/cartItemList"; // 예) bbs/board/boardList.jsp
    }
    ...
    public String modify(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/crt/cartItem/cartItemModify"; // 예) bbs/board/boardModify.jsp
    }
}
