 ...
 */
@Controller
@RequestMapping("/adm/tsk") // 예) /bbs
public class AdmDiaryController {
    ...
    public String page(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/tsk/diary/diary"; // 예) bbs/board/board.jsp
    }
    ...
    public String list(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/tsk/diary/diaryList"; // 예) bbs/board/boardList.jsp
    }
    ...
    public String modify(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/tsk/diary/diaryModify"; // 예) bbs/board/boardModify.jsp
    }
}
