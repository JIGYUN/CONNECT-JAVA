 ...
 */
@Controller
@RequestMapping("/adm/brd") // 예) /bbs
public class AdmBoardPostController {
    ...
    public String page(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/brd/boardPost/boardPost"; // 예) bbs/board/board.jsp
    }
    ...
    public String list(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/brd/boardPost/boardPostList"; // 예) bbs/board/boardList.jsp
    }
    ...
    public String modify(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/brd/boardPost/boardPostModify"; // 예) bbs/board/boardModify.jsp
    }
}
