...
public class AdmCmmnCodeClController {
    ...
    public String page(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/sys/cmmnCodeCl/cmmnCodeCl"; // 예) bbs/board/board.jsp
    }
    ...
    public String list(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/sys/cmmnCodeCl/cmmnCodeClList"; // 예) bbs/board/boardList.jsp
    }
    ...
    public String modify(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/sys/cmmnCodeCl/cmmnCodeClModify"; // 예) bbs/board/boardModify.jsp
    }
}
