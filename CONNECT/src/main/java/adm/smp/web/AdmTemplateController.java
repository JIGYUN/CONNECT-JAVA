 ...
 */
@Controller
@RequestMapping("/adm/BIZ_SEG") // 예) /bbs
public class AdmTemplateController {
    ...
    public String page(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/BIZ_PATH/template"; // 예) bbs/board/board.jsp
    }
    ...
    public String list(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/BIZ_PATH/templateList"; // 예) bbs/board/boardList.jsp
    }
    ...
    public String modify(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/BIZ_PATH/templateModify"; // 예) bbs/board/boardModify.jsp
    }
}