 ...
 */
@Controller
@RequestMapping("/adm/psh") // 예) /bbs
public class AdmPushController {
    ...
    public String page(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/psh/push/push"; // 예) bbs/board/board.jsp
    }
    ...
    public String list(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/psh/push/pushList"; // 예) bbs/board/boardList.jsp
    }
    ...
    public String modify(ModelMap model, @RequestParam HashMap<String,Object> map) throws Exception {
        ...
        model.put("map", map);
        return "adm/psh/push/pushModify"; // 예) bbs/board/boardModify.jsp
    }
}
